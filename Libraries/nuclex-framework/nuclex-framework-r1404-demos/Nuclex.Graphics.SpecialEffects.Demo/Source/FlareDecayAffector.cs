...
namespace Nuclex.Graphics.SpecialEffects.Demo {
  ...
  public class FlareDecayAffector : IParticleAffector<FlareParticle> {

    /// <summary>The default instance of this modifier</summary>
    public static readonly FlareDecayAffector Default = new FlareDecayAffector();
    ...
    ///   </para>
    /// </remarks>
    public bool IsCoalescable { get { return true; } }

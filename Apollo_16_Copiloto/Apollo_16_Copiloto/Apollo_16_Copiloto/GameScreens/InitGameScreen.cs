...
namespace Apollo_16_Copiloto
{
    public class InitGameScreen : BaseGameState
    {
        ...
        Vector2 titlePosition = new Vector2(300, 0);
        Vector2 serverLabel = new Vector2(1080, 700);
        Vector2 menuLabels = new Vector2(600, 400);
        ...
        protected override void LoadContent()
        {
            base.LoadContent();
            /* Background */
            backgroundTexture = content.Load<Texture2D>(@"Backgrounds\copiloto");
